...
\vspace{4pt}
for uSim 2020 Conference % Line 2 - If there is no second line then just put \phantom{Line 2} here
}
...
$^1$uSIM 2020 Secretariat, Some Town, Some Country\\ % Line 5
...
This document explains how to prepare a paper for submission to the uSim 2020 Conference. It also includes the instructions for submission and some other information.
...
The main body of the paper should contain sections that are equivalent to the below, though other titles may be used:
\begin{itemize}
  \item Introduction
...
\section*{Conclusion}
This paper has shown how to prepare a paper for submission to uSim 2020 Conference in Edinburgh.
